<div class="ci-management-panel" dir="ltr">
    <div class="cache">
        ...
        <form method="post" action="">
            <input type="text" name="cache_time" value="<?php echo esc_html(get_option('_ci_cache_time')) ? esc_html(get_option('_ci_cache_time')) : ''; ?>">
            <button name="set_cache_time" type="submit"><?php echo esc_html(__('Set Time', 'cinnamon-cache')); ?></button>
